...
var lambdas = []string{"lambda-cart-additem", "lambda-cart-all", "lambda-cart-clear", "lambda-cart-itemmodify", "lambda-cart-itemtotal", "lambda-cart-modify", "lambda-cart-total", "lambda-cart-user"}
