...
build: ## Build the executable for Lambda
	echo
	GOOS=linux GOARCH=amd64 go build -o bin/addcartitem ./addcartitem
	GOOS=linux GOARCH=amd64 go build -o bin/allcarts ./allcarts
	GOOS=linux GOARCH=amd64 go build -o bin/cartitems ./cartitems
	GOOS=linux GOARCH=amd64 go build -o bin/clearcart ./clearcart
	GOOS=linux GOARCH=amd64 go build -o bin/cartitemstotal ./cartitemstotal
	GOOS=linux GOARCH=amd64 go build -o bin/carttotal ./carttotal
	GOOS=linux GOARCH=amd64 go build -o bin/modifycart ./modifycart
	GOOS=linux GOARCH=amd64 go build -o bin/modifycartitem ./modifycartitem
	echo
